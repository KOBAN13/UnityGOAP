...
namespace GOAP
{
    ...
    public class GoapAgent : MonoBehaviour
    {
        ...
        private void CreatePlan()
        {
            ...
            //есть пару проблем,
            //сделать нормальные приоритеты ибо щас проблема если мало здоровья и стамины то его дрочит между стейтами, такого не должно быть,
            //здоровье более приоритетно и его нельзя отменить пока оно не закончилось.
            //происходит из-за того что цели здоровья нет, и он и выбирает rest.
